...
<head>
    ...
    <title>Login Siswa E-Sekolah</title>
                ...
                <div class="col-lg-6">
                    <div class="card2 card border-0 px-4 py-5">
                        ...
                        <form action="login.php" method="post">
                            <div class="row px-3">
                                <label for="usenisr" class="mb-1">
                                    <h6 class="mb-0 text-sm">NIS Anda</h6>
                                </label>
                                <input type="text" name="nis" id="nis" class="mb-4" placeholder="Masukkan NIS anda!" required>
                            </div>
                            <div class="row px-3">
